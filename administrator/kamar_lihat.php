    ...
    <div id="wrapper" style="background-color: white;">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-book"></i> Lihat Kamar
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h4>Daftar List Kamar</h4>
                        <form class="" method="POST" action="kamar_lihat.php">
                            <div class="col-lg-2">
                                <input type="text" name="cari" placeholder="Cari Kamar" class="form form-control">
                            </div>
                            ...
                            <table class="table table-hover table-striped">
                                ...
                                <?php 
                                 @$cari = $_POST['cari'];
                                    ...
                                    $sql = "SELECT * from tb_kamar where jenis_kamar like '%$cari%'";
                                     }else{
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $informasi['fasilitas']; ?></td>
                                        <td><?php echo $informasi['jenis_kamar']; ?></td>
                                        <td><?php echo "Rp. ".number_format($informasi['harga'],2,",","."); ?></td>
                                        <td><a href="kamar_hapus.php?id=<?php echo $informasi['id_kamar']; ?>" onclick="return confirm('Apakah Anda yakin akan menghapus ini ?');"><button><b style="font-size: 15px;"><span class="fa fa-trash"></span></b></button></a></td>
                                    </tr>
                                    <?php $i=$i+1;} ?>
                                </tbody>
                            </table>
